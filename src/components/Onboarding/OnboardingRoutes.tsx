...
const OnboardingRoutes = () => (
  <Stack.Navigator mode="modal" headerMode="none" initialRouteName="Welcome" screenOptions={() => ({ gestureEnabled: false })}>
    ...
    <Stack.Screen name="Battery" component={BatteryOnboarding} options={{ cardStyleInterpolator: CardStyleInterpolators.forScaleFromCenterAndroid }} initialParams={{ showUsageLink: true }} />
